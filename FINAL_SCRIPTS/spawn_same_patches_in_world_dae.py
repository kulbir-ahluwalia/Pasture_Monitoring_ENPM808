...
pasture_x_width = 30.0
pasture_y_length = 30.0
pasture_area_m2 = pasture_x_width*pasture_y_length

patch_x_width = 0.5   #for x
patch_y_length = 0.5
...
species_1_plants_per_square_meter = 450
...
for x_loop in range(0, 9, 2):
    for y_loop in range(0, 9, 2):
        ...
        file_path_string =  "/home/ksa/Desktop/Pasture_Monitoring/FINAL_SCRIPTS/2mby2m_patches_low_poly2by2m_square_patch_index_0.dae"
        ...
        tree.write('day'+str(day_number)+'_single_patch_species1_PASTURE.world')
        tree = ET.parse('day'+str(day_number)+'_single_patch_species1_PASTURE.world')
        root = tree.getroot()
        count = count + 1
