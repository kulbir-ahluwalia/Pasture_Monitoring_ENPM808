...
#    z_scale = scaling_factor*(ryegrass_predicted_height/rygrass_plant_heights[model_num])
    ...
    x_scale = scaling_factor*(ryegrass_predicted_height/lowpoly_plant_heights[model_num])
    y_scale = scaling_factor*(ryegrass_predicted_height/lowpoly_plant_heights[model_num])
    ...
    bpy.context.active_object.location = (x_val, y_val, z_val)
...
def spawn_patch(x_y_loop_list):
    ...
    patch_name = "npypatch_" + str(x_loop) + "_" + str(y_loop) + "_" + str(x_step_size_patch) + "by" + str(y_step_size_patch) + "_pasturesize" + str(pasture_x_width) +  "by" + str(pasture_y_length)+  "m"


    with open('/home/ksa/Desktop/Pasture_Monitoring/FINAL_SCRIPTS/npy_patches/250_plants_per_square_meter/' + patch_name +'npy_array.npy', 'rb') as f:
...
#      
    ...
    #    
        ...
        patch_path_for_dae_export = "/home/ksa/Desktop/Pasture_Monitoring/patches/day168_max_height_30percent_variance/" + patch_name + ".dae" 
